...
/dev/block/platform/msm_sdcc.1/by-name/radio	/firmware_radio vfat    ro,shortname=lower,fmask=111,context=u:object_r:firmware_file:s0 wait
/dev/block/platform/msm_sdcc.1/by-name/adsp	/firmware_q6    vfat    ro,shortname=lower,fmask=111,context=u:object_r:firmware_file:s0 wait
